...
local Window = Library.CreateLib("ZEPHYR X: LOOMIAN LEGACY", colors)
...
local AutoFarm = Window:NewTab("AutoFarm Gui")
local AutoFarmSection = AutoFarm:NewSection("Gui")
AutoFarmSection:NewButton("AutoFarm Gui", "Open A Gui", function()
    Library:ToggleUI()
    game.StarterGui:SetCore("SendNotification", {Title="SYLSHUB"; Text="We have hidden the UI, open with your Right Shift or your current set keybind!"; Duration=3;})   
...
local teleportsection = Teleport:NewSection("Player Teleport")
